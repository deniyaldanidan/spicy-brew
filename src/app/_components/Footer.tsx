...
const companyList = [
  ...
  URL_LIST.careers,
  URL_LIST.press,
  URL_LIST.howTos.path_children.faqs,
];
const policyList = [
  URL_LIST.termsNConditions,
  URL_LIST.privacy,
  URL_LIST.shipping,
  URL_LIST.returnsNCancellations,
];
  ...
  return (
    <div className={styles.footer}>
      ...
      <div className={styles.secondary}>
        <div className={styles.footerMenu}>
          ...
          {companyList.map((comp) => (
            <Link href={comp.path} key={comp.path}>
              {comp.label}
            </Link>
          ))}
        </div>
        <div className={styles.footerMenu}>
          ...
          {policyList.map((pol) => (
            <Link href={pol.path} key={pol.path}>
              {pol.label}
            </Link>
          ))}
        </div>
        <div className={clsx(styles.footerMenu, styles.addressList)}>
          ...
          <p className={styles.address}>
            ...
            <span>Sunflower Avenue,</span>
            <span>Anna Road, Chennai,</span>
            <span>Tamil Nadu 600002.</span>
          </p>
          <Link href="tel: +91 72 30912456" className={styles.telephone}>
            +91 72 30912456
          </Link>
      ...
      <div className={styles.tertiary}>
        <span>
          Copyright &copy; 2024{" "}
          <Link href="https://danidevstudio.com/">Dani&apos;s Products.</Link>
        </span>
